...
Revision ID: 8674c53d6712
Revises: 
Create Date: 2024-08-08 23:28:39.822465
...
def upgrade() -> None:
    ...
    sa.Column('feedback', sa.Enum('LOW_QUALITY', 'TOO_EXPENSIVE', 'OTHER', 'HIGH_QUALITY', 'EASY_TO_USE', 'GOOD_VALUE', 'SATISFACTORY', 'AVERAGE', name='feedbackenum'), nullable=True),
