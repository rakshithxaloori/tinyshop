...
from app.lib.datetime import calculate_current_period_end
from app.checkout.model import Checkout
from app.subscription.utils.razorpay import create_razorpay_subscription
...
def create_subscription(
    ...
    try:
        ...
        new_sub = Subscription(
            ...
            customer_address_id=(
                cus_addr_id if subscription.customer_address else None
            ),
